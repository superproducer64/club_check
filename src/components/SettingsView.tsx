...
import { Settings, Volume2, ShieldCheck, Cpu, Sliders, Moon, Gauge, RefreshCw, CheckCircle2 } from 'lucide-react';
    ...
    <div className="max-w-md mx-auto p-4 space-y-5 text-stone-100 pb-20">
      ...
      <div>
        ...
        <p className="text-xs text-stone-400 mt-0.5">
          Customize voice prompts, departure sensitivity, and audio alerts.
        </p>
      </div>
          ...
          <button
            ...
            className={`px-3 py-1.5 rounded-xl text-xs font-bold transition flex items-center space-x-1.5 ${
              testPlaying
                ...
                : 'bg-emerald-500 hover:bg-emerald-400 text-emerald-950 shadow'
            }`}
          >
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-1 gap-2 text-xs">
            {[
              ...
              <button
                key={phrase}
                onClick={() => onUpdateSettings({ voicePhrase: phrase as VoicePhrase })}
        ...
        <div className="space-y-1.5">
          ...
          <div className="grid grid-cols-2 gap-2 text-xs">
            {[
              ...
              <button
                key={tone.id}
                onClick={() => onUpdateSettings({ audioTone: tone.id as AudioTone })}
        ...
        <div className="space-y-3">
          <div>
            <div className="flex justify-between text-xs text-stone-300 mb-1.5">
              ...
              <span className="font-bold text-emerald-400">{settings.reminderDistanceMeters} meters (~{Math.round(settings.reminderDistanceMeters * 3.28)} ft)</span>
            </div>
      ...
      <div className="bg-stone-900 border border-stone-800 rounded-2xl p-4 space-y-3">
        ...
        <div className="grid grid-cols-3 gap-2 text-xs">
          {[
            ...
            <button
              key={item.id}
              onClick={() => onUpdateSettings({ playingStyle: item.id as PlayingStyle })}
